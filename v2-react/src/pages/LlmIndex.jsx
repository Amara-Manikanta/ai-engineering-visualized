...
export default function LlmIndex() {
  const models = [
    ...
    },
    {
      ...
      desc: "Meta's concept-level model. Operates on semantic concepts rather than tokens. Uses SONAR embeddings and a diffusion process.",
    ...
    },
    {
      ...
      desc: "Designed to take actions in the world — browse the web, click buttons, run code. Built for agentic tasks, not just conversation.",
    ...
    },
    {
      ...
      desc: "Uses a router to activate only a few specialist sub-networks per token. Massive model capacity with lower compute cost.",
    ...
    },
    {
      ...
      desc: "Understands both images and text together. Can answer questions about images, generate captions, perform visual reasoning.",
    ...
    },
    {
      ...
      desc: "Compact, efficient LLMs that run on-device — phones, laptops, edge hardware. Sacrifices some capability for privacy, speed.",
    ...
    },
    {
      ...
      desc: "Trained by masking words and predicting them using both left and right context. Not for generation — for understanding.",
    ...
    },
    {
      ...
      desc: "Meta's foundation model for image segmentation. Given any prompt, it can precisely segment any object in any image.",
