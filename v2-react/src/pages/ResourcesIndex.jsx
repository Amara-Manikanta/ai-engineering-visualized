...
export default function ResourcesIndex() {
  return (
    <div className="min-h-screen bg-[#0a0a0a] text-white">
      <GlobalHeader />
      <div className="flex flex-col items-center justify-center pt-32 pb-10 px-5 gap-6 text-center">
        <motion.div 
          className="text-6xl"
        ...
        <Link to="/">
          <motion.div 
            ...
            whileTap={{ scale: 0.95 }}
            className="mt-4 px-6 py-3 bg-indigo-600 hover:bg-indigo-500 text-white font-medium rounded-lg transition-colors cursor-pointer"
          >
            ← Back to Home
          </motion.div>
        </Link>
